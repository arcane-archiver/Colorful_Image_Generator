...
void ColorfulImageGenerator::recursivelyDrawGraph(cs225::PNG &image, bool branching, CanvasUtility::CardinalDirection direction, unsigned int x, unsigned int y) {
...
CanvasUtility::Position ColorfulImageGenerator::drawEdge(cs225::PNG &png, unsigned int edgeLength, CanvasUtility::CardinalDirection direction, unsigned int x, unsigned int y) {
  for (unsigned i = 0; i < edgeLength; i++) {
    ...
    if (direction == CanvasUtility::CardinalDirection::North || direction == CanvasUtility::CardinalDirection::South) {
    ...
    } else if (direction == CanvasUtility::CardinalDirection::East || direction == CanvasUtility::CardinalDirection::West) {
  ...
  return CanvasUtility::Position(direction, x, y);
}
